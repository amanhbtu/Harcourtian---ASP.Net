...
<!-- Start cssSlider.com -->
		...
		<ul>
			<li class="cs_skeleton"><img src="cssslider_files/csss_images1/1.jpg" style="width: 100%;" alt=""/></li>
			<li class='num0 img slide'>  <a href="http//:www.google.com" target="_blank"><img src="cssslider_files/csss_images1/1.jpg" alt=""/> </a> </li>
			<li class='num1 img slide'>  <a href="http//:www.google.com" target="_blank"><img src="cssslider_files/csss_images1/2.jpg" alt=""/> </a> </li>
			<li class='num2 img slide'>  <a href="http//:www.google.com" target="_parent"><img src="cssslider_files/csss_images1/3.jpg" alt=""/> </a> </li>
			<li class='num3 img slide'>  <a href="http//:www.google.com" target="_blank"><img src="cssslider_files/csss_images1/4.jpg" alt="" /> </a> </li>
		</ul>
		</div>
		<!-- End cssSlider.com -->
